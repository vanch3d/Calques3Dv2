...
public:
    ...
    //@{
    virtual int  FindObject(CPoint theLoc,CObjectId mask,BOOL bShowLabel=TRUE,BOOL bSub=TRUE);
...
///
/////////////////////////////////////////////////////////////////////////////
class CConeTask : public CPlan3DTask
{
public :
    CConeTask(CView *AParent,UINT taskID);
    virtual unsigned GetTaskResID() const { return CTX_CONE; }

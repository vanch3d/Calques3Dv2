...
BEGIN_MESSAGE_MAP(CViewUniv, CView)
    ...
    ON_COMMAND_RANGE(ID_CONSTRUCTION_INTERSECTION_LINECIRCLE,ID_CONSTRUCTION_INTERSECTION_PLANECIRCLE, OnStartTask)
    ON_COMMAND_RANGE(ID_EXPLORATION_MOVE,ID_EXPLORATION_ANIMATION, OnStartTask)
    ...
    ON_UPDATE_COMMAND_UI_RANGE(ID_CONSTRUCTION_INTERSECTION_LINECIRCLE,ID_CONSTRUCTION_INTERSECTION_PLANECIRCLE, OnUpdateTasks)
    ON_UPDATE_COMMAND_UI_RANGE(ID_EXPLORATION_MOVE,ID_EXPLORATION_ANIMATION, OnUpdateTasks)

...
BEGIN_MESSAGE_MAP(CViewUniv, CView)
    ...
    ON_COMMAND_RANGE(ID_OBJECT_POINT,ID_OBJECT_CONE, OnStartTask)
    ON_COMMAND_RANGE(ID_CONSTRUCTION_POINTON,ID_CONSTRUCTION_DIVSEGMENT, OnStartTask)
    ON_COMMAND_RANGE(ID_CONSTRUCTION_INTERSECTION_LINECIRCLE,ID_CONSTRUCTION_INTERSECTION_LINECONE, OnStartTask)
    ...
    ON_UPDATE_COMMAND_UI_RANGE(ID_OBJECT_POINT,ID_OBJECT_CONE, OnUpdateTasks)
    ON_UPDATE_COMMAND_UI_RANGE(ID_CONSTRUCTION_POINTON,ID_CONSTRUCTION_DIVSEGMENT, OnUpdateTasks)
    ON_UPDATE_COMMAND_UI_RANGE(ID_CONSTRUCTION_INTERSECTION_LINECIRCLE,ID_CONSTRUCTION_INTERSECTION_LINECONE, OnUpdateTasks)
...
void CViewUniv::OnStartTask(UINT nID)
{
    ...
    case ID_OBJECT_CYLINDRE:
        ...
        break;
    case ID_OBJECT_CONE:
        pNewTask = new CConeTask(this,nID);
        break;

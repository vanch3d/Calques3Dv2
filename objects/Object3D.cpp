...
//////////////////////////////////////////////////////////////////////
CString CObject3D::GetObjectNameRedux()
{
    CString mstr,mstr2;
    mstr.LoadString(GetNameID());
	mstr.Replace(_T("#"),_T(""));
...
/// @param nCode	The error code generated by the CalculConceptuel() method,
///					0 if no error.
//////////////////////////////////////////////////////////////////////
void CObject3D::SetValidate(UINT nCode)
{
	bValidate = (nCode==0);
}
...
CString CObject3D::ExportSymbolic(int nFormat)
{
	...
	if (nFormat==EXPORT_MATHEMATICA)
		mstr.Format(_T("(* MISSING OBJECT: %s *)"),GetObjectDef());

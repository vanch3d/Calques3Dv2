...
// Construction
public:
    /*CBCGPShapePopup (	const CArray<COLORREF, COLORREF>& colors,
					COLORREF color, 
    ...
    CBCGPShapePopup (CBCGPShapeButton* pParentBtn,
					 int type,
					 int nShape,
					 int nColumns)
		: m_wndColorBar (type, nShape, nColumns, 
						-1, -1,
						(UINT)-1,
						pParentBtn)
	{
